...
-- -----------------------------------------------------
-- Table `BD-LES`.`Concelho`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `BD-LES`.`Concelho` ;

CREATE TABLE IF NOT EXISTS `BD-LES`.`Concelho` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `nomeConcelho` VARCHAR(45) NOT NULL,
  `Distrito_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_Concelho_Distrito1_idx` (`Distrito_id` ASC),
...
CREATE TABLE IF NOT EXISTS `BD-LES`.`LocalCaptura` (
  `idLocalCaptura` INT NOT NULL AUTO_INCREMENT,
