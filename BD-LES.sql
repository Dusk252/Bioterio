...
CREATE TABLE IF NOT EXISTS `BD-LES`.`elementoEquipa` (
  ...
  INDEX `fk_elementoEquipa_Funcionario1_idx` (`Funcionario_idFuncionario` ASC),
  CONSTRAINT `fk_equipaProjeto_Projeto1`
    FOREIGN KEY (`Projeto_idProjeto`)
    REFERENCES `BD-LES`.`Projeto` (`idProjeto`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_elementoEquipa_Funcionario1`
    FOREIGN KEY (`Funcionario_idFuncionario`)
    REFERENCES `BD-LES`.`Funcionario` (`idFuncionario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `BD-LES`.`Tabela de Controlo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `BD-LES`.`Controlo` (
